...
loadXMCDAv2(xmcdaDatav2, inDirectory, outrankingFile, mandatory = TRUE, xmcdaMessages,"alternativesComparisons")
loadXMCDAv2(xmcdaDatav2, inDirectory, highlightedAlternativesFile, mandatory = FALSE, xmcdaMessages,"alternativesValues")
loadXMCDAv2(xmcdaDatav2, inDirectory, paramsFile, mandatory = TRUE, xmcdaMessages,"methodParameters")
