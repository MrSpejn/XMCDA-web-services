...
loadXMCDAv2(xmcdaDatav2, inDirectory, selectionValuesFile, mandatory = TRUE, xmcdaMessages,"alternativesValues")
loadXMCDAv2(xmcdaDatav2, inDirectory, seedFile, mandatory = FALSE, xmcdaMessages,"methodParameters")
