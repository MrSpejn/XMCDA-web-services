...
loadXMCDAv2(xmcdaDatav2, inDirectory, promethee_profilesFile, mandatory = TRUE, xmcdaMessages,"performanceTable")
loadXMCDAv2(xmcdaDatav2, inDirectory, criteria_weightsFile, mandatory = TRUE, xmcdaMessages,"criteriaValues")
