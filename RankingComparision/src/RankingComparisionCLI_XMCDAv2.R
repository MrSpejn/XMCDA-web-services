...
loadXMCDAv2(xmcdaDatav2, inDirectory, first_rankingFile, mandatory = TRUE, xmcdaMessages,"alternativesValues")
loadXMCDAv2(xmcdaDatav2, inDirectory, second_rankingFile, mandatory = TRUE, xmcdaMessages,"alternativesValues")
